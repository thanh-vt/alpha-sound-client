...
export class TokenInterceptor implements HttpInterceptor {
  ...
  constructor(private authService: AuthService, private router: Router,
              private injector: Injector, private tokenStorageService: TokenStorageService,
  ...
  handleNormalRequestError(request: HttpRequest<any>, next: HttpHandler,
    ...
    if (error.status === 401) {
      ...
      const params = new HttpParams()
        ...
        .set('refresh_token', refreshTokenInfo.token);
  ...
  handleOauth2RequestError(request: HttpRequest<any>, next: HttpHandler,
                           error: HttpErrorResponse): Observable<HttpEvent<any>> {
