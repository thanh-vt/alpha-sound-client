...
@NgModule({
  declarations: [NavbarComponent, SidebarComponent, FooterComponent,
    AddSongToPlaylistComponent, ModalComponent, CardComponent,
    SpinnerComponent, EnvPipe, LoadingComponent,
    ToastComponent, CommonModalComponent, ConfirmationModalComponent],
  imports: [
    CommonModule,
    NgbModule,
    RouterModule,
